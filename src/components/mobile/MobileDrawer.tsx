          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-5 text-xs scrollbar-none">
            ...
            <div>
              ...
              <div className="space-y-1.5">
                ...
                {/* Secure PIN Protected Admin Button */}
                <button
                  onClick={handleAdminClick}
                  className={`w-full flex items-center justify-between p-2.5 rounded-xl font-bold transition border border-purple-500/30 ${
                    viewMode === 'ADMIN'
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <span>🔒 Admin Panel & Payouts</span>
                  </div>
                  <span className="text-[9px] font-mono bg-purple-500/30 text-purple-200 px-1.5 py-0.5 rounded border border-purple-500/40">
                    PIN REQUIRED
                  </span>
                </button>
              </div>
            ...
            <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 text-[10px] text-slate-400 space-y-1 leading-relaxed">
              ...
              <p>
                Free community esports tournaments only. Non-wagering skill-based competition. Independent platform not affiliated with Garena.
              </p>
            </div>
          </div>
